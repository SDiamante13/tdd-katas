...
import com.diamantetechcoaching.officecleaner1.OfficeCleaner1;
import com.diamantetechcoaching.officecleaner9.OfficeCleaner9;
...
class OfficeCleanerTests {
    ...
    void OfficeCleaner1Test(Map.Entry<String, String> data) throws Exception
    {
    ...
    @ParameterizedTest
    @MethodSource("stringProvider")
    void OfficeCleaner9Test(Map.Entry<String, String> data) throws Exception
    {
        String filename = data.getKey();
        String expected = data.getValue();
